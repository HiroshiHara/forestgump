...
<body>
  ...
  <div class="members">
    ...
    <section class="item member">
      <a href="#detail" class="detail">
        <img class="image" src="images/member_sample.jpg" alt="photo">
        <div class="member-name">John Smith</div>
        <nav class="instruments">
          <li class="nav-item">Drums</li>
          <li class="nav-item">Percussion</li>
        </nav>
      </a>
      <!-- modal window -->
      <div id="detail" style="display:none;">
        <h3 class="modal-title">Jhon Smith</h3>
        <img class="modal-image" src="images/member_sample.jpg" alt="photo">
        <!-- 自己紹介テキストは445バイトまで -->
        <p class="modal-text">
